...
if __name__ == "__main__":
    ...
    argparser.add_argument("--more_efficient_training", action="store_true", default=False)
    ...
    argparser.add_argument("--do_train_sample_test", action="store_true", default=False)
