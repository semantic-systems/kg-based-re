...
if __name__ == "__main__":
    ...
    argparser.add_argument("--alt_mode", action="store_true")
    argparser.add_argument("--deactivate_graph", action="store_true")
    argparser.add_argument("--use_only_types", action="store_true")
    argparser.add_argument("--short_cut", action="store_true")
    argparser.add_argument("--gnn_checkpoint", type=str, default=None)
    ...
    argparser.add_argument("--filter_relations", action="store_true")
